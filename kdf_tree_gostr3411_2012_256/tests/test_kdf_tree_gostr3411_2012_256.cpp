...
#include "../src/kdf_tree_gostr3411_2012_256.h"

TEST(KDFTreeGOSTR34112012256, KeyLength256)
{
    uint8_t key[] = {
    ...
    uint8_t expected_derived_key[32] = {
    ...
    {
        EXPECT_EQ(derived_key[i], expected_derived_key[i]);
    }
}

TEST(KDFTreeGOSTR34112012256, KeyLength512)
{
    uint8_t key[] = {
        0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
        0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
    ...
    uint8_t expected_derived_key[64] = {
